...
function initiateGame() {
  context.fillStyle = '#4E78A0';
  context.fillRect(0,0, world.width, world.height);
  world.addPrawn(new Prawn({x: 100, y: 250, color:'#B0171F', ID:'A'}));
  world.addPrawn(new Prawn({x: 400, y: 250, dir: 'left', color: '#F5D3E2', ID:'B'}));
};
...
function startGame() {
  ...
  context.fillText('GET READY TO TRAWN', 250, 200);
  window.setTimeout(initiateGame, 1500);
};
